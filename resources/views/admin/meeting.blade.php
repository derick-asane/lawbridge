...
<div class="flex justify-end">
    <a href=" {{ route('admin.meetingform')}}" class="bg-green-300 border rounded-md py-1 px-2 mr-5 my-4 text-white text-[20px] italic">New Consultation</a>
</div>
            ...
            @foreach($meetings as $meeting)
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-3 flex justify-center">
                        <a href="{{route('admin.joinmeeting', ['meetingId' => $meeting->meeting_id] )}}" class="bg-blue-400 text-white hover:bg-blue-800 py-1 px-4 rounded">Join</a>
                        <a href="#" class="bg-green-400 text-white hover:bg-green-800 ml-2 py-1 px-4 rounded">Edit</a>
